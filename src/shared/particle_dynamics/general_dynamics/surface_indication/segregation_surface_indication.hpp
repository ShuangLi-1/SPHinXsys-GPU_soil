...
#include "segregation_surface_indication.h"
...
SegregationFreeSurfaceIndication<DataDelegationType>::SegregationFreeSurfaceIndication(BaseRelationType &base_relation)
