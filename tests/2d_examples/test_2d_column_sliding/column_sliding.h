...
//----------------------------------------------------------------------
Real DL = 3;                       /**< Tank length. */
Real DH = 3;                      /**< Tank height. */
...
std::vector<Vecd> createOuterWallBlockShape()
{
    ...
    pnts.push_back(Vecd(-2.122, -BW));
    pnts.push_back(Vecd(-2.122, 2.122));
    pnts.push_back(Vecd(0.0, 0.0));
    pnts.push_back(Vecd(2.0, 0.0));
    pnts.push_back(Vecd(2.0, -BW));
    pnts.push_back(Vecd(-2.122, -BW));
...
std::vector<Vecd> createSoilBlockShape()
{
    std::vector<Vecd> pnts;
    Vecd offset(0.0, 0.0);
    pnts.push_back(Vecd(-1.697, 1.697)+ offset);
    pnts.push_back(Vecd(-1.697, 1.414)+ offset);
    pnts.push_back(Vecd(-1.414, 1.414)+ offset);
    pnts.push_back(Vecd(-1.414, 1.697)+ offset);
    pnts.push_back(Vecd(-1.697, 1.697)+ offset);
...
public:
    explicit SoilBlock(const std::string& shape_name) : MultiPolygonShape(shape_name)
    {
        ...
        multi_polygon_.addAPolygon(createOuterWallBlockShape(), ShapeBooleanOps::sub);
