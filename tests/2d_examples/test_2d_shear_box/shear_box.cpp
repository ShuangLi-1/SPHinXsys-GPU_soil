...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<UpdateDiffusivityAndSegregationRate> update_D_and_V(soil_block, LH/0.089);
    //SimpleDynamics<UpdateDiffusivityAndSegregationRateGray2021> update_D_and_V(soil_block, 0.089, shear_period);
    ...
    Real Output_Time = shear_period/2.0;
    Real dt = 0.0;
    //----------------------------------------------------------------------
