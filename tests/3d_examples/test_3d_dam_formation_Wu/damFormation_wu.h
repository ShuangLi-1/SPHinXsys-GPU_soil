...
Real friction_angle = 32.8 * Pi / 180;
Real cohesion = 0.0;
Real dilatancy = 0.0;
Real miu_s = 0.577;
Real miu_d = 0.84;
...
std::string wall_side_full_path_to_file = "./input/wall.stl";
...
class SoilBlock : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(soil_full_path_to_file, Vecd(0.2, 0.51, 0.0), 1.0);
    }
};
