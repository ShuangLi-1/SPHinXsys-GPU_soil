...
class SoilBlock : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(soil_full_path_to_file, Vecd(0.00, 0.51, 0.0), 1.0);
    }
};
...
class WallBoundary : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(wall_base_full_path_to_file, Vecd(0, 0, -0.0), 1.0);
        add<TriangleMeshShapeSTL>(wall_side_full_path_to_file, Vecd(0, 0.5, 0), 1.0);
    }
};
