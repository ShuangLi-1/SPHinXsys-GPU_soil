...
int main(int ac, char *av[])
{
    ...
    //----------------------------------------------------------------------
    BoundingBox system_domain_bounds(Vecd(-500, -1000, -500), Vecd(4000 , 1000, 3000));
    ...
    ReloadParticleIO write_particle_reload_files_soil(soil_block);
    write_particle_reload_files.writeToFile(0.0);
    write_particle_reload_files_soil.writeToFile(0.0);
    //----------------------------------------------------------------------
    ...
    InteractionDynamics<NormalDirectionFromParticles> soil_block_normal_direction(soil_block_inner);
